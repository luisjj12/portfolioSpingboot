...
Puedes probar la demo en producción con esta cuenta:

| Rol | Email | Contraseña |
|---|---|---|
| Usuario normal | usuario@gmail.com | usuario123 |
| Administrador | admin@gmail.com | admin123 |

También puedes registrarte tú mismo desde la web para crear tu propia cuenta.

Si quieres tu propia cuenta de administrador (por ejemplo en local), regístrate normalmente y luego cambia tu rol directamente en la base de datos:

```sql
UPDATE usuarios SET role = 'ADMIN' WHERE email = 'tu-email@ejemplo.com';
```

Vuelve a iniciar sesión: ahora entrarás directamente al panel de administrador.
